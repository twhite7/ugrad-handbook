...
\mysection{Timing of Focal paths}
...
semester to add other courses, regardless of their reasoning.
In some cases they may even force you to graduate early instead of
allowing you to remain to complete your other course plans. If you
plan to get a minor, double major, focal path, etc., please plan to
complete the requirements for each no later than the semester in which
you complete your majors' requirements.
...
The list of courses permitted as Humanities and Social Science (HSS) courses is maintained by the School of Engineering and Applied Sciences, available at A122 Thorton Hall.
At various times a snapshot of this list has been added to an online PDF;
a link to the most recent such list is usually available at \myurl{https://engineering.virginia.edu/uva-engineering-elective-policies}
...
defined by the school and also apply to the BS CpE major.
