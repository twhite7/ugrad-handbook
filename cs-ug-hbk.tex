...
Online: \url{http://www.cs.virginia.edu/}
...
Online: \url{http://www.cs.virginia.edu/acad/bscs/}
...
\begin{center}
\ifthenelse{\boolean{lettersize}}{\epsfig{figure=diagrams/bs-cs.pdf,width=5.5in}}{\epsfig{figure=diagrams/bs-cs.pdf,width=4.5in}}
\end{center}
\end{figure*}
%}
...
Online: \url{http://www.cs.virginia.edu/acad/ba/}
...
exception to be entered for the student; see
section~\ref{sec:sisexceptions} (page~\pageref{sec:sisexceptions}) for
the manual SIS exception process.
...
Online: \url{http://www.cpe.virginia.edu/ugrads/}
...
\ifthenelse{\boolean{lettersize}}{\columnbreak}{}
...
(page~\pageref{sec:sisexceptions}) for the SIS exception
process.
...
\begin{center}
\ifthenelse{\boolean{lettersize}}
{\epsfig{figure=diagrams/bs-cpe.pdf,width=5.5in}}
...
Online: \url{http://www.cs.virginia.edu/acad/cs_minor.html}
...
Online: \url{http://www.cs.virginia.edu/acad/graduate_program/}
...
Online: \url{http://www.cs.virginia.edu/acad/}
