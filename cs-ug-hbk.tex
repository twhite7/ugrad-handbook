...
\item CS electives (5 required): Any 3 credit CS class at the 3000
  ...
  student's academic advisor); this process can be initiated by
  emailing the BA CS director at \bacsdirectoremail. Due to
  substantial overlap, one cannot
...
CS 1110, CS 1111, or CS 1112) with a grade of C+
...
as it is part of the BS CS capstone requirement.  Note that it's
pre-req (CS 4970, Capstone Practicum I) {\em does} count as a CS
elective.
...
requirement for the DMP (see section~\ref{sec:badmp}), and thus does
...
CS 4971 &   &   &   &   &   &   &   &   &   & X &   \\
\end{tabular}
\caption{Course Offering History}
\end{center}
\end{table}
...
\course{CS 4740}{Cloud Computing}{3 credits}{\ldots}{\ldots}
...
the Electrical Engeering department.  Instead, it is meant to list the
required courses for the Computer Engineering majors.  Information
about the other Electical Engineering courses offered can be found
