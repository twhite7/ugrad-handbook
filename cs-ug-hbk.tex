...
handbook will be listed on the individual degree web pages (listed
below) to which the errata or addendum applies.
\newline

The BS CS website is at
\url{http://www.cs.virginia.edu/acad/bscs/}
\newline

The BA CS website is at
\url{http://www.cs.virginia.edu/acad/ba/}
\newline

The BS CpE website is at
...
CS 111x for CLAS majors; placement is available (see sections
...
CS elective, is a strict pre-requisite to CS 4971!  Also note that STS 4500
...
on page~\pageref{fig:bscsreqs}, and is available
