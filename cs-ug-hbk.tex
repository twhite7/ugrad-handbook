...
Systems).  This course takes the place of CS 3330 (Computer
...
change also affects the Electrical Engineering curriculum, but that is
not being covered here.

For any computer science classes that require CS 3330 as a
pre-requisite, ECE 4435 is also allowed.  The one exception is CS/ECE 4457
(Computer Networks), which allows either CS 3330 or ECE 3430 as
...
\item The BA CS does not require CS 1110 as a major requirement;
  instead, it is a pre-requisite, so there is no need to replace it.
