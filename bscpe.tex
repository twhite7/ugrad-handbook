...
\mysection{Curriculum for 2016 and earlier} % called ``Disciplines'' in the original

There have been significant changes to the Computer Engineering
curriculum in the last few years, and there are currently two sets of
requirements: one for students graduating in 2016 or earlier, and one
for students graduating in 2017 and later.  This section is for the
students who are graduating in 2016 or earlier.
...
\mysection{Curriculum for 2017 and later} % called ``Disciplines'' in the original

There have been significant changes to the Computer Engineering
curriculum in the last few years, and there are currently two sets of
requirements: one for students graduating in 2016 or earlier, and one
for students graduating in 2017 and later.  This section is for the
students who are graduating in 2017 and later.

Starting in fall of 2015, Fields (ECE 3209) counts for the PHYS 2415/2419

Changes:
- FUn 1-3 were renamed and are now all 4 credits (some, but not all were 3)
- fields (starting in fall 2015) coults for phys
- 4 UE instead of 5, but if they take fields, they need 5

\subsection{Curriculum Changes}
\label{sec:cpecurriculumchanges}

There were three primary changes to the Computer Engineering
curriculum made in the 2013-2014 academic year.  These changes come
into effect for students graduating in 2017 and later.

\begin{itemlist}

\item Three ECE classes were renamed and changed to four credits each.
Those courses were: ECE 2630 (previously Introductory Circuit Analysis,
now ECE Fundamentals I); ECE 2660 (previously Electronics I, now ECE
Fundamentals II); and ECE 3750 (previously Signals and Systems I, now
ECE Fundamentals III). Note that ECE 2660 was already 4 credits.

\item Due to the increased credit load, the number of unrestricted
elecectives required was lowered down to four (from five).

\item Starting in the fall of 2015, ECE 3209 (Electromagnetic Fields)
will fulfill the SEAS core requirement for PHYS 2415 and 2419.  In
addition, ECE 3209 counts as a CS/ECE elective.
Because students who take ECE 3209 will thus have to take one less
class (since it counts twice: for PHYS 2415/2419 and a CS/ECE
elective), those students will have to take an additional unrestricted
elective (for a total of five).
...
The parts that have changed are in {\bf bold type} in the table
below.  There is a alternative for the fifth semester, which is
...
CS 2110 & Software Develop.\ Methods & 3 \\
CS 2102 & Discrete Mathematics & 3 \\
{\bf ECE 2630} & {\bf ECE Fundamentals I} & {\bf 3} \\
HSS & HSS elective$^1$ & 3 \\
\\
\end{tabular}
...
CS 2150 & Prog.\ \& Data Representation & 3 \\
CS/ECE 2330 & Digital Logic Design & 3 \\
{\bf ECE 2660} & {\bf ECE Fundamentals II} & {\bf 4} \\
UE & Unrestricted elective$^3$ & 3 \\
STS & 2xxx/3xxx elective & 3 \\
\\
\end{tabular}
...
\samplescheduletableheader
\und{Fifth semester} & & \und{{\bf 15}} \\
ECE 3430 & Intro to Embed.\ Systems & 4 \\
{\bf ECE 3750} & {\bf ECE Fundamentals III} & {\bf 4} \\
CS/ECE & CS/ECE elective $^4$ & 3 \\
PHYS 2415/2419 & General Physics II \& Lab & 4 \\
%PHYS 2419 & General Physics Lab I & 1 \\ 
%UE & Unrestricted elective$^3$ & 3 \\
...
\item Chosen from: among BIOL 2010, BIOL 2020, CHEM 1620, ECE 2066, ENGR
  2500, MSE 2090, and PHYS 2620.
\item \label{cpeunrestricted2017} Unrestricted electives may be chosen
  from any graded course in
  the University except mathematics courses below MATH 1310 including
  STAT 1100 and 1120, and courses that substantially duplicate any
  others offered for the degree, including PHYS 2010, 2020; CS 1010,
...
\subsubsection{Alternative Fifth Semester}

For students who are taking CS 3209 (Electromagnetic Fields) as a CS/ECE
elective in their fifth semester, the schedule will change slighly.
As described in section~\ref{sec:cpecurriculumchanges}, ECE 3209
counts as both a CS/ECE elective and as the PHYS 2415/2419 SEAS core
requirement.  However, students must take an additional unrestricted
elective in place.  Thus, their fifth semester will look like the
following:

\samplescheduletableheader
\und{Alternative fifth semester} & & \und{{\bf 15}} \\
ECE 3430 & Intro to Embed.\ Systems & 4 \\
{\bf ECE 3750} & {\bf ECE Fundamentals III} & {\bf 4} \\
ECE 3209 & Electromagnetic Fields $^4$ & 4 \\
%PHYS 2415/2419 & General Physics II \& Lab & 4 \\
%PHYS 2419 & General Physics Lab I & 1 \\ 
UE & Unrestricted elective$^3$ & 3 \\
\\
...
Starting in the fall of 2015, computer engineering majors are allowed
to take ECE 3209 (Electromagnetic Fields) in place of PHYS 2415/2419
-- for full details, see section~\ref{sec:cpecurriculumchanges}.
While this option is only open to computer engineering majors, it also
applied to dual CS/CpE majors as well.
